 ...
 * @author Walter
 */
public class ApplyLeaveUser extends javax.swing.JFrame {
 ...
 public ApplyLeaveUser(String myid) {
        initComponents();
 ...
 void seachLeave()
    ...
    void updateleave()
    {
        try
        {
            ...
            int resp;
            String query = "update takeleave set sdate=?, edate=?, reason=?  where id=?";
    ...
    private void displayTable()
    {
        ...
        {
            ResultSet rs;
            String query = "select * from takeleave where empId='"+myid+"'  ";
            rs = conn.stmt.executeQuery(query);
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(tn)
                                    .addComponent(ctype, 0, 124, Short.MAX_VALUE)))
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                    .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(edc, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApplyLeaveUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApplyLeaveUser().setVisible(true);
            }
        });
    }
