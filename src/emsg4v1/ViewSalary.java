...
void dispTableUser() 
{
        ...
        {
            ResultSet rs;
            String query = "select * from salary where empId= (select id from emp where fname= '"+tn.getText()+"') ";
            //String query2 = "select id,fname,contact from emp where id = (select empId from salary where id= '"+tid.getText()+"') ";
            rs = conn.stmt.executeQuery(query);
            //rs2 = conn.stmt.executeQuery(query2);
    ...
    void search()
    {
        ...
        {
          ResultSet rs;
           String query = "select * from salary where id = '"+tid.getText()+"' ";
          //String query = "select id,fname,contact from emp where id = (select empId from salary where id= '"+tid.getText()+"') ";
    ...
    private void initComponents() {
        ...
        cbdisp.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Id", "All" }));
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(ttot, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(tbonus, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jLabel1.setText("View Employee Salary");

        jButton2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButton2.setText("New Salary ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            slip();
            JOptionPane.showMessageDialog(this,"SLIP ","SLIP GENERATED ... gO CHECK...", HEIGHT);
        }
        else
    ...
    private void cbdispActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbdispActionPerformed
        ...
        if(tid.getText().isEmpty() && cbdisp.getSelectedItem().equals(""))
        {
            
        }
        else if(cbdisp.getSelectedItem().equals("Id"))
        {
            model.setRowCount(0);
            dispTableUser();
        }
